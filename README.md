...
- Slimefun base: 3,957 files
- Addons: 21 addon namespaces
- Assets total: 19,243 files
- Full pack total including overlays and docs: about 20,000 files
...
Do not unzip the release ZIP unless you want to edit the pack.
...
See [CREDITS.md](CREDITS.md). This pack is a merge and organization project based on several Slimefun community packs. Original texture rights remain with their authors.

## License And Permissions

See [LICENSE.md](LICENSE.md), [NOTICE.md](NOTICE.md), and [ATTRIBUTION.md](ATTRIBUTION.md).

This project is a compilation and organization work. Original assets remain owned by their original creators. If you are an original author and want a credit corrected or an asset removed, open an issue or contact the maintainer.
