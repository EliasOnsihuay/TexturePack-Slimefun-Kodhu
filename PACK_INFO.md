...
| Folder | Purpose |
|---|---|
| `assets` | Main Java resource pack assets |
| `ia_overlay_1_21_4_to_5` | ItemsAdder-style compatibility overlay |
| `ia_overlay_1_21_6_plus` | ItemsAdder-style compatibility overlay |
| `overlay_1_21_6_plus` | Modern Minecraft overlay |
| `overlay_1_21_11` | Modern Minecraft overlay |
| `overlay_26_1_2` | Newest Minecraft format overlay |

## Java Notes

This is the primary supported version of the pack.
